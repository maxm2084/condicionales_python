...
print(pregunta_1)
ingreso=str.lower(input("Ingrese su respuesta: "))
if ingreso==respuesta_1:
    puntaje_inicializada+=10
else:
    puntaje_inicializada

print(pregunta_2)
ingreso=str.lower(input("Ingrese su respuesta: "))
if ingreso==respuesta_2:
    puntaje_inicializada+=10
else:
    puntaje_inicializada
...
print(pregunta_3)
ingreso=str.lower(input("Ingrese su respuesta: "))
if ingreso==respuesta_3:
    puntaje_inicializada+=10
else:
    puntaje_inicializada
print(pregunta_4)
ingreso=str.lower(input("Ingrese su respuesta: "))
if ingreso==respuesta_4:
    puntaje_inicializada+=10
else:
    puntaje_inicializada
